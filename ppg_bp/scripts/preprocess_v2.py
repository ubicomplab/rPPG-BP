...
def select_chunk(mat_data, chunk_amount):
    ...
    for pos in top3:
        ...
        if len(new_chunks) != 5:
            ...
            continue
        # top3_chunk_list.append([pos[1], new_chunks])
        top3_chunk_list.append([pos[1], (int(pos[0]), int(pos[0]) + chunk_amount - 1)])
    return top3_chunk_list
...
if __name__ == "__main__":
    ...
    chunk_mat_savepath = "/gscratch/ubicomp/cm74/bp/bp_preprocess/ppg_chunks_mat_palm_230110"
    ...
    for mat_path in all_mat_path:
        ...
        try:
            ...
            top3_chunk_list = select_chunk(np.array(chunk_list), chunk_amount=5)
            # if draw_select_ppg:
            #     plt.figure()
    ...
    plt.savefig(os.path.join(figure_savepath, "palm_top_ppg_subplots.png"))
    ...
    plt.savefig(os.path.join(figure_savepath, "palm_bottom_ppg_subplots.png"))
